...
public class activity_add_new_friend extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, Serializable {
    ...
    Spinner spinner;
    String male;//Only have 2 values: male and female
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                person = new Person(edtFirstName.getText().toString(),
                ...
                textView.setText("person: " +  friend.toString() );
    ...
    public void returnToMain(){
        ...
        intentReturn.putExtra("male", male);
    ...
    public void putValueToSpinner(){
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                male = parent.getItemAtPosition(position).toString();
            }
